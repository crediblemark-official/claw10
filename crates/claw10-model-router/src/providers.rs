...
fn openai() -> ProviderConfig {
    config(
        ...
        vec![
            model("gpt-4o", 128_000, 16_384, 2.50, 10.00, vec!["general", "reasoning", "coding", "vision"]),
            model("gpt-4o-mini", 128_000, 16_384, 0.15, 0.60, vec!["general", "coding", "fast", "vision"]),
            model("gpt-4.1", 1_047_576, 16_384, 2.00, 8.00, vec!["general", "reasoning", "coding", "vision"]),
            model("gpt-4.1-mini", 1_047_576, 16_384, 0.40, 1.60, vec!["general", "coding", "vision"]),
            model("gpt-4.1-nano", 1_047_576, 16_384, 0.10, 0.40, vec!["general", "fast", "vision"]),
...
fn anthropic_compat() -> ProviderConfig {
    config(
        ...
        vec![
            model("claude-sonnet-4-20250514", 200_000, 8_192, 3.00, 15.00, vec!["general", "reasoning", "coding", "vision"]),
            model("claude-3.5-sonnet", 200_000, 8_192, 3.00, 15.00, vec!["general", "reasoning", "coding", "vision"]),
            model("claude-3.5-haiku", 200_000, 8_192, 0.80, 4.00, vec!["general", "fast", "coding", "vision"]),
            model("claude-3-opus", 200_000, 4_096, 15.00, 75.00, vec!["reasoning", "vision"]),
        ],
    )
}
...
fn openrouter() -> ProviderConfig {
    config(
        ...
        vec![
            model("openai/gpt-4o", 128_000, 16_384, 2.50, 10.00, vec!["general", "coding", "vision"]),
            model("openai/gpt-4o-mini", 128_000, 16_384, 0.15, 0.60, vec!["general", "fast", "vision"]),
            model("openai/o3-mini", 200_000, 100_000, 1.10, 4.40, vec!["reasoning"]),
            model("anthropic/claude-sonnet-4", 200_000, 8_192, 3.00, 15.00, vec!["general", "reasoning", "vision"]),
            model("google/gemini-2.0-flash-001", 1_048_576, 8_192, 0.10, 0.40, vec!["general", "fast", "vision"]),
            model("google/gemini-2.5-pro-preview-03-25", 1_048_576, 64_000, 1.25, 5.00, vec!["reasoning", "vision"]),
...
fn google_gemini_compat() -> ProviderConfig {
    config(
        ...
        vec![
            model("gemini-2.5-pro-exp-03-25", 1_048_576, 64_000, 1.25, 5.00, vec!["reasoning", "coding", "general", "vision"]),
            ...
            model("gemini-1.5-pro", 2_097_152, 8_192, 1.25, 5.00, vec!["general", "reasoning", "vision"]),
            model("gemini-1.5-flash", 1_048_576, 8_192, 0.075, 0.30, vec!["general", "fast", "vision"]),
        ],
    )
}
